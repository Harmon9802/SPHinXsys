 ...
 */
#include "windows_frame_diffusion_D2.h"
#include "sphinxsys.h"
...
int main(int ac, char *av[])
{
    ...
    boundary_Robin_in.generateParticles<ParticleGeneratorLattice>();
    ...
    boundary_Robin_ex.generateParticles<ParticleGeneratorLattice>();
    //----------------------------------------------------------------------
    //	Particle and body creation of temperature observers.
    //----------------------------------------------------------------------
    ObserverBody temperature_observer(sph_system, "TemperatureObserver");
    temperature_observer.generateParticles<ObserverParticleGenerator>();
    //----------------------------------------------------------------------
    ...
    BodyRegionByParticle wood_body(diffusion_body, makeShared<MultiPolygonShape>(createWoodBody()));
    ...
    SimpleDynamics<ThermalConductivityInitialization> wood_conductivity_initial_condition(wood_body, wood_cond);
    ...
    ReducedQuantityRecording<ReduceDynamics<QuantitySummation<Real>>>
        write_diffusion_changing_rate(io_environment, diffusion_body, "PhiChangeRate");
    ReducedQuantityRecording<ReduceDynamics<QuantitySummation<Real>>>
        write_heat_flux(io_environment, diffusion_body, "HT_Flux");
    ...
    wood_conductivity_initial_condition.exec();
    ...
    //----------------------------------------------------------------------
    int ite = 0;
    Real T0 = 0.04;//for steady state
    Real End_Time = T0;
    Real Observe_time = 0.01 * End_Time;
    Real Output_Time = 0.05 * End_Time;
    Real dt = 0.0;
    //----------------------------------------------------------------------
